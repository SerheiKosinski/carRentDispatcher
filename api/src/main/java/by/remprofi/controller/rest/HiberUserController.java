...
import by.remprofi.servis.HiberUserService;
...
public class HiberUserController {

    private final HiberUserService userService;
    ...
    public ResponseEntity<Object> updateUser(Principal principal, @RequestBody UserUpdateRequest request) {
        ...
        one.setViolations(request.getViolations());
